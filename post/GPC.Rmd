...
For tensorflow implementation, check out my repo [GPC-tensorflow](https://github.com/pengluyaoyao/Gaussian-Process-Classification-Using-Tensorflow-probability). Also check Tensorflow-probability [Tensorflow-probability](https://www.tensorflow.org/probability), [Tensorflow-probability repo](https://github.com/tensorflow/probability)
